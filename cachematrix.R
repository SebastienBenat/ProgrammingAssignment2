## These functions are used to calculate and store in cache a matrix and its 
## inverse matrix. So these data could be used without having to compute
## inverse matrix each time

## the function makeCacheMatrix gets a matrix as input to store it in cache and
## define access functions to the matrix and its inverse (get / set for matrix 
## and inverse). Matrix and inverse are stored in cache by using <<- operator
